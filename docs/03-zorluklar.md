...
**Çözüm yolu:** Ayar seçimi (K-011) ayrıntılı taramadan sonra kullanıcıyla birlikte verilecek. Seçilen ayar ne olursa olsun, kalibrasyon protokolü (nötr uyaranda taban hızlar → eşikler) Faz 4'te uygulanacak.
