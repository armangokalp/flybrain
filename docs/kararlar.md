...
- **Bedel 3 (kullanıcı kabul etti):** Bağlı sinekte **takip ve sekme kanalları ölüyor**. Göğüs sabitlenince karın ve baş eklemleri görünürlük eşiğini (1°) hiç aşmıyor (ölçüm: karın 0,16°, baş 0,005°) ve K-032 o kararları onaylamıyor. Kalibrasyonda takip %2,1 → %0, sekme %1,3 → %0; doğrulamada ikisi de hiç seçilmedi. Önceki oturumda sinek 6 hesap takip etmişti. Eşiği düşürüp kanalı geri getirmek kuralı istenen sonuca uydurmak olurdu; yapılmadı. Bağlı sinek beğenir, kaydeder, yorum yazar, kaydırır, tımar eder ve korkar — takip edemez.
